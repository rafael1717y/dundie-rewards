...
@pytest.mark.unit
@pytest.mark.parametrize("address", ["bruno@.com", "@doe.com", "a@b", "/@gm"])
...
def test_generate_simple_password():
    """Test generation of random simples passwords.
    TODO: Generate hashed complex passwords, enctrypit it
    """
    passwords = []
    for _ in range(100):
